...
# Hint #1
# Write a recursive function that paints the pixel if it's the correct color, then recurse on neighboring pixels.
...
class Solution:
    def floodFill(self, image: list, sr: int, sc: int, newColor: int) -> list:
        ...
        if (oldColor==newColor):
            ...
            a = self.fill(image,sr, sc, newColor, oldColor)
            return a
